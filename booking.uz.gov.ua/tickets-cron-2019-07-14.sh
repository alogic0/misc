...
PNM='OD - KOV'
PZD='from=2208001&to=2218020&time=00%3A00&train=058Ш&get_tpl=1'

#PNM='KOV - OD'
#PZD='from=2218020&to=2208001&time=00%3A00&train=084%D0%9B&get_tpl=1'

mkdir -p $HOME/tmp/kov-od 2>/dev/null

[ -d $HOME/tmp/kov-od ] || { echo "Error in making /tmp/kov-od"; exit 1; }
